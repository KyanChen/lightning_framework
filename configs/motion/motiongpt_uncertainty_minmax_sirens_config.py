...
model_cfg = dict(
    ...
    head=dict(
        ...
        uncertainty_beta=1000,
        loss='uncertainty_loss',
        global_position_loss=dict(type='SmoothL1Loss', loss_weight=10.0),
...
callbacks = [
    ...
    dict(
        ...
        save_dir=f'results/motiongpt_vis/vis_uncertainty_maxmin_siren_{exp_name}',
        fps=29,
    )
]
