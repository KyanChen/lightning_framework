...
def build_sam_vit_h(checkpoint=None, train_head=False):
    return _build_sam(
...
def build_sam_vit_l(checkpoint=None, train_head=False):
    return _build_sam(
...
def build_sam_vit_b(checkpoint=None, train_head=False):
    return _build_sam(
